...
# 3. BASE DE DADOS COMPLETA (37 Unidades - Corrigido erro São Jorge Ponto Remoto)
dados_agencias = {
    ...
    "Agf Vila Sonia": {"mcu": "00424435", "wan1": {"op": "Claro", "tipo": "FIXO", "ip": "201.6.100.11", "mask": "255.255.255.0", "gw": "01.6.100.1"}, "wan2": {"op": "Vivo", "tipo": "PPPoE", "ip": "187.35.124.176", "user": "Nat 192.168.15.200", "pass": "não tem"}},
